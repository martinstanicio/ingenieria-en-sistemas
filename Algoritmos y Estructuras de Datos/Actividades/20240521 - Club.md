...
mostrar(cantidad_hombres_A)
mostrar(cantidad_mujeres_A)
mostrar(cantidad_personas_A)
mostrar(cantidad_hombres_B)
mostrar(cantidad_mujeres_B)
mostrar(cantidad_personas_B)
mostrar(cantidad_hombres_C)
mostrar(cantidad_mujeres_C)
mostrar(cantidad_personas_C)

mostrar(promedio_edad_hombres)
mostrar(promedio_edad_mujeres)

mostrar(mayor_numero_socio_par)
mostrar(menor_numero_socio_impar)
...
flowchart TB
	...
	comienzo --> variables --> inicializar --> numero_socio --> categoria --> sexo --> edad --> a --> mayor_par
