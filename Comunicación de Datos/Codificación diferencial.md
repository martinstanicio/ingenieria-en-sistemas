...
Es una técnica para codificar [[Dato digital|Datos digitales]] en una [[Señal digital]] o [[Señal analógica|Analógica]], donde la [[Sistemas y Procesos de Negocios/Información]] transmitida se representa mediante ==variaciones== entre [[Elemento de señal|Elementos de señal]] ==sucesivos==. Por ejemplo:
