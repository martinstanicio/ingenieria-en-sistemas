...
- $f$: [[Análisis Matemático I/Función|Función]] de [[Lógica y Estructuras Discretas/Estado|Estado]] siguiente, $f: \left( k \times I \right) \to k$
- $g$: [[Análisis Matemático I/Función|Función]] de [[Salidas|Salida]], $g: k \to O$ para [[Máquina de Moore|Máquinas de Moore]] y $g: \left( k \times I \right) \to O$ para [[Máquina de Mealy|Máquinas de Mealy]]
